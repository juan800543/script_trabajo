...
Qué hace el script, en orden:
  ...
  5. Guarda el resultado en un archivo .xlsx NUEVO, con la fecha y la hora
...
def limpiar_fecha(valor):
    ...
    # Caso 1: el archivo guardó la celda como fecha real, no como texto.
...
def main():
    ...
    for fila in filas:
        ...
        # Se copian solo las columnas que sobreviven, limpiando la fecha
        # al pasar por la columna Date.
        fila_nueva = []
